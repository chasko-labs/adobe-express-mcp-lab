...
> **Primary source fetched:** `https://experienceleague.adobe.com/en/docs/experience-platform/rtcdp/intro/rtcdp-mcp` (2026-06-18, Beta) — *web_fetch 2026-08-31*
...
| **Source** | [`experienceleague.adobe.com — Work with MCP clients (Beta) rtcdp-mcp`](https://experienceleague.adobe.com/en/docs/experience-platform/rtcdp/intro/rtcdp-mcp) — *web_fetch 2026-08-31, last update 2026-06-18* |

#### Beta, Security & Legal Notices — Verbatim Quotes

> **Source:** Same Adobe page § *"Beta, security, and legal notices"* — quoted verbatim:
...
1. **Sandbox first:** Follow Adobe's explicit guidance: *“testing integrations in a sandbox environment prior to productive use”* — applies to **both** beta and community servers. ([source](https://experienceleague.adobe.com/en/docs/experience-platform/rtcdp/intro/rtcdp-mcp))
...
- **RTCDP remote HTTP + browser OAuth + Beta disclaimer as-is + sandbox + rep-gated + client list (Claude/ChatGPT/Codex/Cursor/VS Code):** `https://experienceleague.adobe.com/en/docs/experience-platform/rtcdp/intro/rtcdp-mcp` — *web_fetch 2026-08-31* (last update 2026-06-18). All verbatim quotes in §1.2 sourced there.
...
*Generated for lab deliverable `docs/adobe-mcp-landscape.md`. Re-fetch live GitHub/npm for current stars/downloads before publishing.*
